...
import 'package:healthng/repository/teahos_repository.dart';
...
class TeachHos extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {    
    var hosController = HospitalController(TeachRepository());
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(children: <Widget>[
            Text('Federal Teaching Hospitals', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.grey[800]),),
            Spacer(),
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Expanded(
                                            child: Text('${hospital?.town}'+', '+'${hospital?.state}',
                                            style: TextStyle(
                                              fontSize: 13,
