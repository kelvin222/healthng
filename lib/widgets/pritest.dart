...
class Privatest extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {    
    var covidtController = CovidtestController(CovidtRepository());
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(children: <Widget>[
            Text('Private Covid Test Laboratories', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.grey[800]),),
            Spacer(),
        ...
        Container(
          ...
          child: FutureBuilder<List<Covidtest>>(
            future: covidtController.fetchCovtList(),
                      ...
                      children: <Widget>[
                        Hero(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(10),
                              child: CustomCacheImage(imageUrl:'${cov?.image}'))
                          ),
                        ),
                        Positioned(
                          height: 120,
