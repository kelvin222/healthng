...
import 'package:healthng/repository/sporth_repository.dart';
...
class SporthHos extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {    
    var hosController = HospitalController(SporthRepository());
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(children: <Widget>[
            Text('National Orthopaedic Hospitals', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.grey[800]),),
            Spacer(),          
          ],),
        ),
