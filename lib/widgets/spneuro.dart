...
import 'package:healthng/repository/spneuro_repository.dart';
...
class SpneuroHos extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {    
    var hosController = HospitalController(SpneuroRepository());
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(children: <Widget>[
            Text('Federal Neuro-Psychiatric Hospitals', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.grey[800]),),
            Spacer(),          
          ],),
        ),
