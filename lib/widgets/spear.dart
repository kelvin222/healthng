...
import 'package:healthng/repository/spear_repository.dart';
...
class SpearHos extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {    
    var hosController = HospitalController(SpearRepository());
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(children: <Widget>[
            Text('National Ear Care Centre', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Colors.grey[800]),),
            Spacer(),          
          ],),
        ),
